...
- GitHub Pages is on (`main` / `/`). Live demo: https://RR-Centific.github.io/Sesame-Tracker/ (production repo `Sesame-Tracker`; the Aug 2026 client demo also remains at `Wave-Checklist-Beta`)
